...
namespace DigiSim
{
    ...
    public class AppSettings
    {
        ...
        public const string XML_FILE_ID_STR = "DigiSim_AppSettings";
        ...
        /// <summary>Full file name of the DigiSim file to load.</summary>
        public string DigiSimFileName = "";
        ...
        public void LoadSettings()
        {
            ...
            try
            {
                ...
                try
                {
                    DigiSimFileName = nodeSettings.SelectSingleNode("digisim_filename").InnerText;
                }
                catch { }
                ...
                try
                {
                    XmlNode nodeRecentDigiSim = nodeSettings.SelectSingleNode("recent_digisim_files");
                    XmlNodeList digisimItems = nodeRecentDigiSim.SelectNodes("item");
                    foreach (XmlNode digisimItem in digisimItems)
                    {
                        RecentDigiSimFiles.Add(digisimItem.InnerText);
                    }
                }
                catch { }
        ...
        public bool LoadSchematics(string FileName)
        {
            ...
            try
            {
                ...
                try
                {
                    DigiSimFileName = nodeSettings.SelectSingleNode("digism_filename").InnerText;
                }
                catch { }
        ...
        public void SaveSettings()
        {
            try
            {
                ...
                nodeSettings.AppendChild(doc.CreateElement("digisim_filename")).AppendChild(doc.CreateTextNode(DigiSimFileName));
                ...
                XmlNode nodeDigiSimFiles = nodeSettings.AppendChild(doc.CreateElement("recent_digisim_files"));
                for (int i = 0; i < RecentDigiSimFiles.Count; i++)
                {
                    XmlNode digisimItem = doc.CreateElement("item");
